  ...
  return (
    <div className="space-y-8">
      <div className="space-y-4">
        ...
        <div className="text-lg sm:text-xl lg:text-2xl text-gray-300 space-y-2">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:space-x-6 text-xs sm:text-sm text-gray-400">
